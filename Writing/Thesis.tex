\documentclass[final]{pittetd}%   If you want to use dvipdfm. The file is to be normally processed (LaTeX), and 
...
\section{ATLAS}
\subsection{Coordinate System Used in ATLAS}%            Remember to capitalize the sections (otherwise, the bookmark will be lowercase)
